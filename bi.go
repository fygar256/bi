...
// ============================================================
// Terminal raw mode helpers (FreeBSD compatible)
// ============================================================

// FreeBSDでは Linux の TCGETS/TCSETS の代わりに TIOCGETA/TIOCSETA を使用します
const (
	TIOCGETA = 0x402c7413 // FreeBSD の TIOCGETA 定数
	TIOCSETA = 0x802c7414 // FreeBSD の TIOCSETA 定数
)
